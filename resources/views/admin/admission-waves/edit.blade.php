{{-- resources/views/admin/admission-waves/edit.blade.php --}}
@extends('layouts.app')
@section('title', 'Ubah Gelombang')
@section('content')
<div class="max-w-lg mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-xl font-semibold text-text mt-2">Ubah Gelombang</h1>
    </div>
    <div class="bg-surface border border-border rounded-lg p-6">
        <form method="POST" action="{{ route('admin.admission-waves.update', $wave) }}" class="space-y-5">
            @csrf @method('PUT')
            @include('admin.admission-waves.partials.form-fields', ['academicYears' => $academicYears, 'wave' => $wave])
